...
export class EditComponent implements OnInit {
  ...
  edit() {
    ...
    this.spinner.start();
    this.profileService.update(this.dataProfile.id, this.profile).subscribe(
      (data) => {
        const end = new Date();
        ...
        setTimeout(() => {
          ...
          this.notification(
            '<span class="tim-icons icon-bell-55" [data-notify]="icon"></span> Ha editado su perfil exitosamente',
            "5000",
            "success",
            "top",
            "center"
